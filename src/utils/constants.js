...
export const AMBIENT_SOUNDS = [
  { name: "None", file: null },
  { name: "Acoustic Guitar", file: "/sounds/acoustic-guitar.mp3" },
  { name: "Acoustic Guitar 2", file: "/sounds/acoustic-guitar-2.mp3" },
  { name: "Acoustic Nature", file: "/sounds/acoustic-the-beat-of-nature.mp3" },
  { name: "Ambient Flow", file: "/sounds/ambiance.mp3" },
  { name: "Calm River", file: "/sounds/calm-river-nature-ambient-sound.mp3" },
  { name: "Coniferous Forest", file: "/sounds/coniferous-forest.mp3" },
  { name: "Fireplace", file: "/sounds/fireplace.mp3" },
  { name: "Lo-fi Jazz Focus", file: "/sounds/focus-1-lofi-jazz.mp3" },
  { name: "Focus Study", file: "/sounds/focus-study-amp-working.mp3" },
  { name: "Focus Zone", file: "/sounds/focus-zone-relax-mellow-lofi-music.mp3" },
  { name: "Rain Sound", file: "/sounds/freak-rain-sound.mp3" },
  { name: "Healing Cosmic", file: "/sounds/healing-cosmic-sleep-amp-focus-frequency.mp3" },
  { name: "Just Relax", file: "/sounds/just-relax.mp3" },
  { name: "Lo-fi Beat", file: "/sounds/lofi-beat-lofi-music.mp3" },
  { name: "Nature Ambience", file: "/sounds/nature-ambience.mp3" },
  { name: "Nature Birds Morning", file: "/sounds/nature-birds-ambiance-morning-kisses.mp3" },
  { name: "Nature Forest", file: "/sounds/nature-forest-sound.mp3" },
  { name: "Nature Mixed", file: "/sounds/nature.mp3" },
  { name: "Relaxing Rain", file: "/sounds/relaxing-rain-sounds.mp3" },
  { name: "Lake Waves", file: "/sounds/waves-gentle-lake-water.mp3" },
  { name: "Waterside", file: "/sounds/waterside-soft-lake-lite-waves.mp3" },
  { name: "Energetic", file: "/sounds/energetic_23sec.mp3" },
